...
public class AuthenticationFilter extends FormAuthenticationFilter {
	...
	protected org.apache.shiro.authc.AuthenticationToken createToken(
		...
		System.out.println(username+", "+password+", "+captchaId+", "+captcha+", "+rememberMe);
		return new com.leebbs.AuthenticationToken(username, password, captchaId, captcha, rememberMe,host);
	}
	...
	protected boolean onLoginSuccess(
			...
			ServletRequest servletRequest, ServletResponse servletResponse)throws IOException,Exception {
	...
	protected String getPassword(ServletRequest servletRequest) {
		HttpServletRequest httpServletRequest = (HttpServletRequest) servletRequest;
		//String str = this.rsaService.decryptParameter(this.enPasswordParam,httpServletRequest);
		//this.rsaService.removePrivateKey(httpServletRequest);
	...
	protected String getCaptchaId(ServletRequest servletRequest) {
		String captchaId = WebUtils.getCleanParam(servletRequest, this.captchaIdParam);
		if (captchaId == null) {
